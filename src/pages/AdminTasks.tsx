                ...
                <div className="space-y-6">
                    ...
                    <div className="hidden print:block mb-6 border-b-2 border-slate-800 pb-4">
                        <div className="flex justify-between items-end">
                            <div>
                                <h1 className="text-2xl font-bold text-slate-900 uppercase tracking-wider">Task Management Report</h1>
                            ...
                            <div className="flex-1 w-full min-h-0">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                                        ...
                                        <Bar dataKey="ongoing" name="Ongoing" stackId="a" fill="#8b5cf6" />
                                        <Bar dataKey="pending" name="Open" stackId="a" fill="#cbd5e1" />
                                        <Bar dataKey="open" name="Pending" stackId="a" fill="#f97316" />
                                    </BarChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
                    ...
                    <div className="print-section">
                        <h3 className="text-lg font-bold text-slate-800 mb-2 border-b pb-1 uppercase hidden print:block">4. Detailed Tasks</h3>
                                            ...
                                            <tr key={task.id} className="hover:bg-slate-50 break-inside-avoid">
                                                ...
                                                <td className="p-3 text-center">
                                                    {task.approvalStatus === 'APPROVED' ? (
                                                        <span className="text-emerald-600 font-bold flex items-center justify-center gap-1"><Check size={14} /> Approved</span>
                                                    ) : task.approvalStatus === 'REJECTED' ? (
                                                        <span className="text-red-600 font-bold flex items-center justify-center gap-1"><X size={14} /> Rejected</span>
                                                    ) : (
                                                        <div className="flex justify-center gap-2">
                                                            <button
                                                                onClick={() => updateTask({ ...task, approvalStatus: 'APPROVED' })}
                                                            ...
                                                            <button
                                                                onClick={() => updateTask({ ...task, approvalStatus: 'REJECTED' })}
