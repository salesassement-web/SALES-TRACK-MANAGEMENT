...
import { LayoutDashboard, FileText, LogOut, Briefcase, Users, UserCog, Layers, X, CheckSquare, ClipboardList, Settings, DatabaseBackup, Shield, Wifi, WifiOff, Loader2 } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  const { currentUser, logout, appConfig, connectionStatus } = useApp();
